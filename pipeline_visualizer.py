...
if project_pipelines and isinstance(project_pipelines, dict):
    ...
    for pipeline_name, pipeline_id, tab in zip(pipeline_options.keys(), pipeline_options.values(), tabs):
        with tab:
            # Fetch builds using the class method, passing organization and project as parameters.
            builds = azure_api_instance.get_builds_for_pipeline(ORGANIZATION, current_project, pipeline_id, max_builds=selected_build_value)
